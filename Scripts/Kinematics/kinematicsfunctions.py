...
#%% Lookup table, converts wells formatted as 'a1' ... 'h12' to servo angles
...
#%% Simple movement in the xy plane ~4 mm intervals. Up is in reference to the plate and the center of the dispenser.
